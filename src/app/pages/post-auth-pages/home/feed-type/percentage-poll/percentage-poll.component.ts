...
@Component({
	selector: 'app-percentage-poll',
	templateUrl: './percentage-poll.component.html',
	styleUrls: ['./percentage-poll.component.scss']
})
export class PercentagePollComponent implements OnInit {
	@Input() data: any;
